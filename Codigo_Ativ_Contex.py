print ('Olá, Usuário! Este programa tem como objetivo automatizar seu procedimento de histologia utilizando o microscópio confocal.\n Seja bem-vind@.\n')
...
print ('Obrigad@!\A calibração do eixo vertical foi realizada corretamente')

print ('Parabéns!\O microscópio confocal está calibrado e configurado de acordo com seu objetivo.')
